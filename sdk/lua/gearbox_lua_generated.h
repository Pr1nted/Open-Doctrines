...
static int gbxlua_asset_size(lua_State *L) {
    ...
    lua_pushinteger(L, (lua_Integer)gearbox_asset_size(a1, (uint32_t)a1_n));
    return 1;
}
...
static int gbxlua_play(lua_State *L) {
    ...
    lua_pushinteger(L, (lua_Integer)gearbox_play(a1, (uint32_t)a1_n, (uint32_t)(a2)));
    return 1;
}
...
static int gbxlua_set_volume(lua_State *L) {
    lua_Integer a1 = luaL_checkinteger(L, 1);
    lua_Integer a2 = luaL_checkinteger(L, 2);
    gearbox_set_volume((uint32_t)(a1), (uint32_t)(a2));
    return 0;
}
...
static int gbxlua_is_playing(lua_State *L) {
    lua_Integer a1 = luaL_checkinteger(L, 1);
    lua_pushboolean(L, (int)gearbox_is_playing((uint32_t)(a1)));
    return 1;
}
...
static int gbxlua_at_war(lua_State *L) {
    lua_Integer a1 = luaL_checkinteger(L, 1);
    lua_Integer a2 = luaL_checkinteger(L, 2);
    lua_pushboolean(L, (int)gearbox_at_war((uint32_t)(a1), (uint32_t)(a2)));
    return 1;
}
...
static int gbxlua_allied(lua_State *L) {
    lua_Integer a1 = luaL_checkinteger(L, 1);
    lua_Integer a2 = luaL_checkinteger(L, 2);
    lua_pushboolean(L, (int)gearbox_allied((uint32_t)(a1), (uint32_t)(a2)));
    return 1;
}
...
static int gbxlua_non_aggression(lua_State *L) {
    lua_Integer a1 = luaL_checkinteger(L, 1);
    lua_Integer a2 = luaL_checkinteger(L, 2);
    lua_pushboolean(L, (int)gearbox_non_aggression((uint32_t)(a1), (uint32_t)(a2)));
    return 1;
}
...
static int gbxlua_guaranteed(lua_State *L) {
    lua_Integer a1 = luaL_checkinteger(L, 1);
    lua_Integer a2 = luaL_checkinteger(L, 2);
    lua_pushboolean(L, (int)gearbox_guaranteed((uint32_t)(a1), (uint32_t)(a2)));
    return 1;
}
...
static int gbxlua_country_income_gross(lua_State *L) {
    lua_Integer a1 = luaL_checkinteger(L, 1);
    lua_pushnumber(L, (lua_Number)gearbox_country_income_gross((uint32_t)(a1)));
    return 1;
}
...
static int gbxlua_country_income_net(lua_State *L) {
    lua_Integer a1 = luaL_checkinteger(L, 1);
    lua_pushnumber(L, (lua_Number)gearbox_country_income_net((uint32_t)(a1)));
    return 1;
}
...
static int gbxlua_country_army_upkeep(lua_State *L) {
    lua_Integer a1 = luaL_checkinteger(L, 1);
    lua_pushnumber(L, (lua_Number)gearbox_country_army_upkeep((uint32_t)(a1)));
    return 1;
}
...
static int gbxlua_country_navy_upkeep(lua_State *L) {
    lua_Integer a1 = luaL_checkinteger(L, 1);
    lua_pushnumber(L, (lua_Number)gearbox_country_navy_upkeep((uint32_t)(a1)));
    return 1;
}
...
static int gbxlua_country_is_bankrupt(lua_State *L) {
    lua_Integer a1 = luaL_checkinteger(L, 1);
    lua_pushboolean(L, (int)gearbox_country_is_bankrupt((uint32_t)(a1)));
    return 1;
}
...
static int gbxlua_province_industry_level(lua_State *L) {
    lua_Integer a1 = luaL_checkinteger(L, 1);
    lua_pushinteger(L, (lua_Integer)gearbox_province_industry_level((uint32_t)(a1)));
    return 1;
}
...
static int gbxlua_province_industry_specialization(lua_State *L) {
    lua_Integer a1 = luaL_checkinteger(L, 1);
    uint32_t need = gearbox_province_industry_specialization((uint32_t)(a1), NULL, 0);
    if (need == 0) { lua_pushliteral(L, ""); return 1; }
    luaL_Buffer b;
    char *dst = luaL_buffinitsize(L, &b, need);
    uint32_t got = gearbox_province_industry_specialization((uint32_t)(a1), dst, need);
    if (got > need) got = need;   /* host grew it between calls */
    luaL_pushresultsize(&b, got);
    return 1;
}
...
static int gbxlua_province_resource(lua_State *L) {
    ...
    lua_pushnumber(L, (lua_Number)gearbox_province_resource((uint32_t)(a1), a2, (uint32_t)a2_n));
    return 1;
}
...
static int gbxlua_country_expenses(lua_State *L) {
    lua_Integer a1 = luaL_checkinteger(L, 1);
    lua_pushnumber(L, (lua_Number)gearbox_country_expenses((uint32_t)(a1)));
    return 1;
}
...
static int gbxlua_country_national_value(lua_State *L) {
    lua_Integer a1 = luaL_checkinteger(L, 1);
    lua_pushnumber(L, (lua_Number)gearbox_country_national_value((uint32_t)(a1)));
    return 1;
}
...
static int gbxlua_country_at(lua_State *L) {
    lua_Integer a1 = luaL_checkinteger(L, 1);
    uint32_t h = gearbox_country_at((uint32_t)(a1 - 1));
...
static int gbxlua_country_name(lua_State *L) {
    lua_Integer a1 = luaL_checkinteger(L, 1);
    uint32_t need = gearbox_country_name((uint32_t)(a1), NULL, 0);
    if (need == 0) { lua_pushliteral(L, ""); return 1; }
    luaL_Buffer b;
    char *dst = luaL_buffinitsize(L, &b, need);
    uint32_t got = gearbox_country_name((uint32_t)(a1), dst, need);
    if (got > need) got = need;   /* host grew it between calls */
    luaL_pushresultsize(&b, got);
    return 1;
}
...
static int gbxlua_country_treasury(lua_State *L) {
    lua_Integer a1 = luaL_checkinteger(L, 1);
    lua_pushnumber(L, (lua_Number)gearbox_country_treasury((uint32_t)(a1)));
    return 1;
}
...
static int gbxlua_country_province_count(lua_State *L) {
    lua_Integer a1 = luaL_checkinteger(L, 1);
    lua_pushinteger(L, (lua_Integer)gearbox_country_province_count((uint32_t)(a1)));
    return 1;
}
...
static int gbxlua_province_population(lua_State *L) {
    lua_Integer a1 = luaL_checkinteger(L, 1);
    lua_pushinteger(L, (lua_Integer)gearbox_province_population((uint32_t)(a1)));
    return 1;
}
...
static int gbxlua_set_country_treasury(lua_State *L) {
    lua_Integer a1 = luaL_checkinteger(L, 1);
    double a2 = (double)luaL_checknumber(L, 2);
    lua_pushboolean(L, (int)gearbox_set_country_treasury((uint32_t)(a1), a2));
    return 1;
}
...
static int gbxlua_add_country_treasury(lua_State *L) {
    lua_Integer a1 = luaL_checkinteger(L, 1);
    double a2 = (double)luaL_checknumber(L, 2);
    lua_pushboolean(L, (int)gearbox_add_country_treasury((uint32_t)(a1), a2));
    return 1;
}
...
static int gbxlua_set_province_owner(lua_State *L) {
    lua_Integer a1 = luaL_checkinteger(L, 1);
    lua_Integer a2 = luaL_checkinteger(L, 2);
    lua_pushboolean(L, (int)gearbox_set_province_owner((uint32_t)(a1), (uint32_t)(a2)));
    return 1;
}
...
static int gbxlua_set_province_population(lua_State *L) {
    lua_Integer a1 = luaL_checkinteger(L, 1);
    lua_Integer a2 = luaL_checkinteger(L, 2);
    lua_pushboolean(L, (int)gearbox_set_province_population((uint32_t)(a1), (int64_t)a2));
    return 1;
}
...
static int gbxlua_width(lua_State *L) {
    (void)L;
    lua_pushinteger(L, (lua_Integer)gearbox_width());
    return 1;
}
...
static int gbxlua_height(lua_State *L) {
    (void)L;
    lua_pushinteger(L, (lua_Integer)gearbox_height());
    return 1;
}
...
static int gbxlua_province_count(lua_State *L) {
    (void)L;
    lua_pushinteger(L, (lua_Integer)gearbox_province_count());
    return 1;
}
...
static int gbxlua_province_at(lua_State *L) {
    lua_Integer a1 = luaL_checkinteger(L, 1);
    uint32_t h = gearbox_province_at((uint32_t)(a1 - 1));
    if (h == GEARBOX_INVALID) lua_pushnil(L);
    else lua_pushinteger(L, (lua_Integer)h);
    return 1;
}
...
static int gbxlua_province_name(lua_State *L) {
    lua_Integer a1 = luaL_checkinteger(L, 1);
    uint32_t need = gearbox_province_name((uint32_t)(a1), NULL, 0);
    if (need == 0) { lua_pushliteral(L, ""); return 1; }
    luaL_Buffer b;
    char *dst = luaL_buffinitsize(L, &b, need);
    uint32_t got = gearbox_province_name((uint32_t)(a1), dst, need);
    if (got > need) got = need;   /* host grew it between calls */
    luaL_pushresultsize(&b, got);
    return 1;
}
...
static int gbxlua_province_center_x(lua_State *L) {
    lua_Integer a1 = luaL_checkinteger(L, 1);
    lua_pushnumber(L, (lua_Number)gearbox_province_center_x((uint32_t)(a1)));
    return 1;
}
...
static int gbxlua_province_center_y(lua_State *L) {
    lua_Integer a1 = luaL_checkinteger(L, 1);
    lua_pushnumber(L, (lua_Number)gearbox_province_center_y((uint32_t)(a1)));
    return 1;
}
...
static int gbxlua_province_is_land(lua_State *L) {
    lua_Integer a1 = luaL_checkinteger(L, 1);
    lua_pushboolean(L, (int)gearbox_province_is_land((uint32_t)(a1)));
    return 1;
}
...
static int gbxlua_province_neighbor_count(lua_State *L) {
    lua_Integer a1 = luaL_checkinteger(L, 1);
    lua_pushinteger(L, (lua_Integer)gearbox_province_neighbor_count((uint32_t)(a1)));
    return 1;
}
...
static int gbxlua_province_neighbor_at(lua_State *L) {
    lua_Integer a1 = luaL_checkinteger(L, 1);
    lua_Integer a2 = luaL_checkinteger(L, 2);
    uint32_t h = gearbox_province_neighbor_at((uint32_t)(a1), (uint32_t)(a2 - 1));
    if (h == GEARBOX_INVALID) lua_pushnil(L);
    else lua_pushinteger(L, (lua_Integer)h);
    return 1;
}
...
static int gbxlua_province_is_coastal(lua_State *L) {
    lua_Integer a1 = luaL_checkinteger(L, 1);
    lua_pushboolean(L, (int)gearbox_province_is_coastal((uint32_t)(a1)));
    return 1;
}
...
static int gbxlua_sea_route_exists(lua_State *L) {
    ...
    double a2 = (double)luaL_checknumber(L, 2);
    double a3 = (double)luaL_checknumber(L, 3);
    double a4 = (double)luaL_checknumber(L, 4);
    lua_pushboolean(L, (int)gearbox_sea_route_exists(a1, a2, a3, a4));
    return 1;
}
...
static int gbxlua_point_is_land(lua_State *L) {
    double a1 = (double)luaL_checknumber(L, 1);
    double a2 = (double)luaL_checknumber(L, 2);
    lua_pushboolean(L, (int)gearbox_point_is_land(a1, a2));
    return 1;
}
#endif /* GBX_WITH_MAP */
...
static int gbxlua_editor_active(lua_State *L) {
    (void)L;
    lua_pushboolean(L, (int)gearbox_editor_active());
    return 1;
}
...
static int gbxlua_editor_province_count(lua_State *L) {
    (void)L;
    lua_pushinteger(L, (lua_Integer)gearbox_editor_province_count());
    return 1;
}
...
static int gbxlua_editor_province_at(lua_State *L) {
    lua_Integer a1 = luaL_checkinteger(L, 1);
    lua_pushinteger(L, (lua_Integer)gearbox_editor_province_at((uint32_t)(a1 - 1)));
    return 1;
}
...
static int gbxlua_editor_province_population(lua_State *L) {
    lua_Integer a1 = luaL_checkinteger(L, 1);
    lua_pushinteger(L, (lua_Integer)gearbox_editor_province_population((uint32_t)(a1)));
    return 1;
}
...
static int gbxlua_editor_province_industry_level(lua_State *L) {
    lua_Integer a1 = luaL_checkinteger(L, 1);
    lua_pushinteger(L, (lua_Integer)gearbox_editor_province_industry_level((uint32_t)(a1)));
    return 1;
}
...
static int gbxlua_editor_province_fortification(lua_State *L) {
    lua_Integer a1 = luaL_checkinteger(L, 1);
    lua_pushinteger(L, (lua_Integer)gearbox_editor_province_fortification((uint32_t)(a1)));
    return 1;
}
...
static int gbxlua_editor_province_port_level(lua_State *L) {
    lua_Integer a1 = luaL_checkinteger(L, 1);
    lua_pushinteger(L, (lua_Integer)gearbox_editor_province_port_level((uint32_t)(a1)));
    return 1;
}
...
static int gbxlua_editor_province_resource(lua_State *L) {
    ...
    size_t a2_n = 0;
    const char *a2 = luaL_checklstring(L, 2, &a2_n);
    lua_pushnumber(L, (lua_Number)gearbox_editor_province_resource((uint32_t)(a1), a2, (uint32_t)a2_n));
    return 1;
}
...
static int gbxlua_editor_province_compass_econ(lua_State *L) {
    lua_Integer a1 = luaL_checkinteger(L, 1);
    lua_pushnumber(L, (lua_Number)gearbox_editor_province_compass_econ((uint32_t)(a1)));
    return 1;
}
...
static int gbxlua_editor_province_compass_social(lua_State *L) {
    lua_Integer a1 = luaL_checkinteger(L, 1);
    lua_pushnumber(L, (lua_Number)gearbox_editor_province_compass_social((uint32_t)(a1)));
    return 1;
}
...
static int gbxlua_editor_set_province_population(lua_State *L) {
    lua_Integer a1 = luaL_checkinteger(L, 1);
    lua_Integer a2 = luaL_checkinteger(L, 2);
    lua_pushboolean(L, (int)gearbox_editor_set_province_population((uint32_t)(a1), (int64_t)a2));
    return 1;
}
...
static int gbxlua_editor_set_province_industry_level(lua_State *L) {
    lua_Integer a1 = luaL_checkinteger(L, 1);
    lua_Integer a2 = luaL_checkinteger(L, 2);
    lua_pushboolean(L, (int)gearbox_editor_set_province_industry_level((uint32_t)(a1), (uint32_t)(a2)));
    return 1;
}
...
static int gbxlua_editor_set_province_fortification(lua_State *L) {
    lua_Integer a1 = luaL_checkinteger(L, 1);
    lua_Integer a2 = luaL_checkinteger(L, 2);
    lua_pushboolean(L, (int)gearbox_editor_set_province_fortification((uint32_t)(a1), (uint32_t)(a2)));
    return 1;
}
...
static int gbxlua_editor_set_province_port_level(lua_State *L) {
    lua_Integer a1 = luaL_checkinteger(L, 1);
    lua_Integer a2 = luaL_checkinteger(L, 2);
    lua_pushboolean(L, (int)gearbox_editor_set_province_port_level((uint32_t)(a1), (uint32_t)(a2)));
    return 1;
}
...
static int gbxlua_editor_set_province_resource(lua_State *L) {
    ...
    const char *a2 = luaL_checklstring(L, 2, &a2_n);
    double a3 = (double)luaL_checknumber(L, 3);
    lua_pushboolean(L, (int)gearbox_editor_set_province_resource((uint32_t)(a1), a2, (uint32_t)a2_n, a3));
    return 1;
}
...
static int gbxlua_editor_set_province_compass(lua_State *L) {
    ...
    double a2 = (double)luaL_checknumber(L, 2);
    double a3 = (double)luaL_checknumber(L, 3);
    lua_pushboolean(L, (int)gearbox_editor_set_province_compass((uint32_t)(a1), a2, a3));
    return 1;
}
...
static int gbxlua_editor_map_name(lua_State *L) {
    ...
    luaL_Buffer b;
    char *dst = luaL_buffinitsize(L, &b, need);
    uint32_t got = gearbox_editor_map_name(dst, need);
    if (got > need) got = need;   /* host grew it between calls */
    luaL_pushresultsize(&b, got);
    return 1;
}
...
static int gbxlua_editor_set_map_name(lua_State *L) {
    size_t a1_n = 0;
    const char *a1 = luaL_checklstring(L, 1, &a1_n);
    lua_pushboolean(L, (int)gearbox_editor_set_map_name(a1, (uint32_t)a1_n));
    return 1;
}
...
static int gbxlua_editor_set_author(lua_State *L) {
    size_t a1_n = 0;
    const char *a1 = luaL_checklstring(L, 1, &a1_n);
    lua_pushboolean(L, (int)gearbox_editor_set_author(a1, (uint32_t)a1_n));
    return 1;
}
...
static int gbxlua_editor_set_license(lua_State *L) {
    size_t a1_n = 0;
    const char *a1 = luaL_checklstring(L, 1, &a1_n);
    lua_pushboolean(L, (int)gearbox_editor_set_license(a1, (uint32_t)a1_n));
    return 1;
}
...
static int gbxlua_ship_count(lua_State *L) {
    (void)L;
    lua_pushinteger(L, (lua_Integer)gearbox_ship_count());
    return 1;
}
...
static int gbxlua_ship_at(lua_State *L) {
    lua_Integer a1 = luaL_checkinteger(L, 1);
    lua_pushinteger(L, (lua_Integer)gearbox_ship_at((uint32_t)(a1 - 1)));
    return 1;
}
...
static int gbxlua_ship_exists(lua_State *L) {
    lua_Integer a1 = luaL_checkinteger(L, 1);
    lua_pushboolean(L, (int)gearbox_ship_exists((uint32_t)(a1)));
    return 1;
}
...
static int gbxlua_ship_owner(lua_State *L) {
    lua_Integer a1 = luaL_checkinteger(L, 1);
    lua_pushinteger(L, (lua_Integer)gearbox_ship_owner((uint32_t)(a1)));
    return 1;
}
...
static int gbxlua_ship_type(lua_State *L) {
    lua_Integer a1 = luaL_checkinteger(L, 1);
    uint32_t need = gearbox_ship_type((uint32_t)(a1), NULL, 0);
    if (need == 0) { lua_pushliteral(L, ""); return 1; }
    luaL_Buffer b;
    char *dst = luaL_buffinitsize(L, &b, need);
    uint32_t got = gearbox_ship_type((uint32_t)(a1), dst, need);
    if (got > need) got = need;   /* host grew it between calls */
    luaL_pushresultsize(&b, got);
    return 1;
}
...
static int gbxlua_ship_lon(lua_State *L) {
    lua_Integer a1 = luaL_checkinteger(L, 1);
    lua_pushnumber(L, (lua_Number)gearbox_ship_lon((uint32_t)(a1)));
    return 1;
}
...
static int gbxlua_ship_lat(lua_State *L) {
    lua_Integer a1 = luaL_checkinteger(L, 1);
    lua_pushnumber(L, (lua_Number)gearbox_ship_lat((uint32_t)(a1)));
    return 1;
}
...
static int gbxlua_ship_health(lua_State *L) {
    lua_Integer a1 = luaL_checkinteger(L, 1);
    lua_pushinteger(L, (lua_Integer)gearbox_ship_health((uint32_t)(a1)));
    return 1;
}
...
static int gbxlua_ship_crew(lua_State *L) {
    lua_Integer a1 = luaL_checkinteger(L, 1);
    lua_pushinteger(L, (lua_Integer)gearbox_ship_crew((uint32_t)(a1)));
    return 1;
}
...
static int gbxlua_ship_range(lua_State *L) {
    lua_Integer a1 = luaL_checkinteger(L, 1);
    lua_pushnumber(L, (lua_Number)gearbox_ship_range((uint32_t)(a1)));
    return 1;
}
...
static int gbxlua_army_stack_count(lua_State *L) {
    lua_Integer a1 = luaL_checkinteger(L, 1);
    lua_pushinteger(L, (lua_Integer)gearbox_army_stack_count((uint32_t)(a1)));
    return 1;
}
...
static int gbxlua_army_stack_owner(lua_State *L) {
    lua_Integer a1 = luaL_checkinteger(L, 1);
    lua_Integer a2 = luaL_checkinteger(L, 2);
    lua_pushinteger(L, (lua_Integer)gearbox_army_stack_owner((uint32_t)(a1), (uint32_t)(a2 - 1)));
    return 1;
}
...
static int gbxlua_army_stack_size(lua_State *L) {
    lua_Integer a1 = luaL_checkinteger(L, 1);
    lua_Integer a2 = luaL_checkinteger(L, 2);
    lua_pushinteger(L, (lua_Integer)gearbox_army_stack_size((uint32_t)(a1), (uint32_t)(a2 - 1)));
    return 1;
}
...
static int gbxlua_country_army(lua_State *L) {
    lua_Integer a1 = luaL_checkinteger(L, 1);
    lua_pushinteger(L, (lua_Integer)gearbox_country_army((uint32_t)(a1)));
    return 1;
}
...
static int gbxlua_province_fortification(lua_State *L) {
    lua_Integer a1 = luaL_checkinteger(L, 1);
    lua_pushinteger(L, (lua_Integer)gearbox_province_fortification((uint32_t)(a1)));
    return 1;
}
...
static int gbxlua_province_port_level(lua_State *L) {
    lua_Integer a1 = luaL_checkinteger(L, 1);
    lua_pushinteger(L, (lua_Integer)gearbox_province_port_level((uint32_t)(a1)));
    return 1;
}
...
static int gbxlua_troop_type_count(lua_State *L) {
    (void)L;
    lua_pushinteger(L, (lua_Integer)gearbox_troop_type_count());
    return 1;
}
...
static int gbxlua_troop_type_id(lua_State *L) {
    lua_Integer a1 = luaL_checkinteger(L, 1);
    uint32_t need = gearbox_troop_type_id((uint32_t)(a1 - 1), NULL, 0);
    if (need == 0) { lua_pushliteral(L, ""); return 1; }
    luaL_Buffer b;
    char *dst = luaL_buffinitsize(L, &b, need);
    uint32_t got = gearbox_troop_type_id((uint32_t)(a1 - 1), dst, need);
    if (got > need) got = need;   /* host grew it between calls */
    luaL_pushresultsize(&b, got);
    return 1;
}
...
static int gbxlua_country_army_of_type(lua_State *L) {
    ...
    size_t a2_n = 0;
    const char *a2 = luaL_checklstring(L, 2, &a2_n);
    lua_pushinteger(L, (lua_Integer)gearbox_country_army_of_type((uint32_t)(a1), a2, (uint32_t)a2_n));
    return 1;
}
...
static int gbxlua_order_army_move(lua_State *L) {
    ...
    lua_Integer a2 = luaL_checkinteger(L, 2);
    lua_Integer a3 = luaL_checkinteger(L, 3);
    lua_pushboolean(L, (int)gearbox_order_army_move((uint32_t)(a1), (uint32_t)(a2), (uint32_t)(a3)));
    return 1;
}
...
static int gbxlua_order_ship_move(lua_State *L) {
    ...
    double a2 = (double)luaL_checknumber(L, 2);
    double a3 = (double)luaL_checknumber(L, 3);
    lua_pushboolean(L, (int)gearbox_order_ship_move((uint32_t)(a1), a2, a3));
    return 1;
}
...
static int gbxlua_order_ship_engage(lua_State *L) {
    lua_Integer a1 = luaL_checkinteger(L, 1);
    lua_Integer a2 = luaL_checkinteger(L, 2);
    lua_pushboolean(L, (int)gearbox_order_ship_engage((uint32_t)(a1), (uint32_t)(a2)));
    return 1;
}
...
static int gbxlua_send(lua_State *L) {
    ...
    size_t a2_n = 0;
    const char *a2 = luaL_checklstring(L, 2, &a2_n);
    lua_pushboolean(L, (int)gearbox_send((uint32_t)(a1), a2, (uint32_t)a2_n));
    return 1;
}
...
static int gbxlua_peer_count(lua_State *L) {
    (void)L;
    lua_pushinteger(L, (lua_Integer)gearbox_peer_count());
    return 1;
}
...
static int gbxlua_self_peer(lua_State *L) {
    (void)L;
    lua_pushinteger(L, (lua_Integer)gearbox_self_peer());
    return 1;
}
...
static int gbxlua_is_host(lua_State *L) {
    (void)L;
    lua_pushboolean(L, (int)gearbox_is_host());
    return 1;
}
...
static int gbxlua_peer_at(lua_State *L) {
    lua_Integer a1 = luaL_checkinteger(L, 1);
    lua_pushinteger(L, (lua_Integer)gearbox_peer_at((uint32_t)(a1 - 1)));
    return 1;
}
...
static int gbxlua_peer_name(lua_State *L) {
    lua_Integer a1 = luaL_checkinteger(L, 1);
    uint32_t need = gearbox_peer_name((uint32_t)(a1 - 1), NULL, 0);
    if (need == 0) { lua_pushliteral(L, ""); return 1; }
    luaL_Buffer b;
    char *dst = luaL_buffinitsize(L, &b, need);
    uint32_t got = gearbox_peer_name((uint32_t)(a1 - 1), dst, need);
    if (got > need) got = need;   /* host grew it between calls */
    luaL_pushresultsize(&b, got);
    return 1;
}
...
static int gbxlua_max_message_bytes(lua_State *L) {
    (void)L;
    lua_pushinteger(L, (lua_Integer)gearbox_max_message_bytes());
    return 1;
}
#endif /* GBX_WITH_NET */
...
static int gbxlua_feature_count(lua_State *L) {
    (void)L;
    lua_pushinteger(L, (lua_Integer)gearbox_feature_count());
    return 1;
}
...
static int gbxlua_features(lua_State *L) {
    lua_Integer a1 = luaL_checkinteger(L, 1);
    uint32_t need = gearbox_features((uint32_t)(a1), NULL, 0);
    if (need == 0) { lua_pushliteral(L, ""); return 1; }
    luaL_Buffer b;
    char *dst = luaL_buffinitsize(L, &b, need);
    uint32_t got = gearbox_features((uint32_t)(a1), dst, need);
    if (got > need) got = need;   /* host grew it between calls */
    luaL_pushresultsize(&b, got);
    return 1;
}
...
static int gbxlua_reward_count(lua_State *L) {
    (void)L;
    lua_pushinteger(L, (lua_Integer)gearbox_reward_count());
    return 1;
}
...
static int gbxlua_reward_mean(lua_State *L) {
    lua_Integer a1 = luaL_checkinteger(L, 1);
    lua_pushnumber(L, (lua_Number)gearbox_reward_mean((uint32_t)(a1 - 1)));
    return 1;
}
...
static int gbxlua_module_count(lua_State *L) {
    (void)L;
    lua_pushinteger(L, (lua_Integer)gearbox_module_count());
    return 1;
}
...
static int gbxlua_module_name(lua_State *L) {
    lua_Integer a1 = luaL_checkinteger(L, 1);
    uint32_t need = gearbox_module_name((uint32_t)(a1), NULL, 0);
    if (need == 0) { lua_pushliteral(L, ""); return 1; }
    luaL_Buffer b;
    char *dst = luaL_buffinitsize(L, &b, need);
    uint32_t got = gearbox_module_name((uint32_t)(a1), dst, need);
    if (got > need) got = need;   /* host grew it between calls */
    luaL_pushresultsize(&b, got);
    return 1;
}
...
static int gbxlua_action_count(lua_State *L) {
    lua_Integer a1 = luaL_checkinteger(L, 1);
    lua_pushinteger(L, (lua_Integer)gearbox_action_count((uint32_t)(a1)));
    return 1;
}
...
static int gbxlua_action_name(lua_State *L) {
    lua_Integer a1 = luaL_checkinteger(L, 1);
    lua_Integer a2 = luaL_checkinteger(L, 2);
    uint32_t need = gearbox_action_name((uint32_t)(a1), (uint32_t)(a2), NULL, 0);
    if (need == 0) { lua_pushliteral(L, ""); return 1; }
    luaL_Buffer b;
    char *dst = luaL_buffinitsize(L, &b, need);
    uint32_t got = gearbox_action_name((uint32_t)(a1), (uint32_t)(a2), dst, need);
    if (got > need) got = need;   /* host grew it between calls */
    luaL_pushresultsize(&b, got);
    return 1;
}
...
static int gbxlua_country_is_ai(lua_State *L) {
    lua_Integer a1 = luaL_checkinteger(L, 1);
    lua_pushboolean(L, (int)gearbox_country_is_ai((uint32_t)(a1)));
    return 1;
}
...
static int gbxlua_update_count(lua_State *L) {
    (void)L;
    lua_pushinteger(L, (lua_Integer)gearbox_update_count());
    return 1;
}
...
static int gbxlua_model_loaded(lua_State *L) {
    (void)L;
    lua_pushboolean(L, (int)gearbox_model_loaded());
    return 1;
}
...
static int gbxlua_ai_version(lua_State *L) {
    ...
    luaL_Buffer b;
    char *dst = luaL_buffinitsize(L, &b, need);
    uint32_t got = gearbox_ai_version(dst, need);
    if (got > need) got = need;   /* host grew it between calls */
    luaL_pushresultsize(&b, got);
    return 1;
}
...
static int gbxlua_ai_arch(lua_State *L) {
    (void)L;
    lua_pushinteger(L, (lua_Integer)gearbox_ai_arch());
    return 1;
}
...
static int gbxlua_country_stance(lua_State *L) {
    lua_Integer a1 = luaL_checkinteger(L, 1);
    lua_pushinteger(L, (lua_Integer)gearbox_country_stance((uint32_t)(a1)));
    return 1;
}
...
static int gbxlua_stance_name(lua_State *L) {
    lua_Integer a1 = luaL_checkinteger(L, 1);
    uint32_t need = gearbox_stance_name((uint32_t)(a1 - 1), NULL, 0);
    if (need == 0) { lua_pushliteral(L, ""); return 1; }
    luaL_Buffer b;
    char *dst = luaL_buffinitsize(L, &b, need);
    uint32_t got = gearbox_stance_name((uint32_t)(a1 - 1), dst, need);
    if (got > need) got = need;   /* host grew it between calls */
    luaL_pushresultsize(&b, got);
    return 1;
}
...
static int gbxlua_stance_count(lua_State *L) {
    (void)L;
    lua_pushinteger(L, (lua_Integer)gearbox_stance_count());
    return 1;
}
...
static int gbxlua_action_valid(lua_State *L) {
    lua_Integer a1 = luaL_checkinteger(L, 1);
    uint32_t need = gearbox_action_valid((uint32_t)(a1), NULL, 0);
    if (need == 0) { lua_pushliteral(L, ""); return 1; }
    luaL_Buffer b;
    char *dst = luaL_buffinitsize(L, &b, need);
    uint32_t got = gearbox_action_valid((uint32_t)(a1), dst, need);
    if (got > need) got = need;   /* host grew it between calls */
    luaL_pushresultsize(&b, got);
    return 1;
}
...
static int gbxlua_country_compass_econ(lua_State *L) {
    lua_Integer a1 = luaL_checkinteger(L, 1);
    lua_pushnumber(L, (lua_Number)gearbox_country_compass_econ((uint32_t)(a1)));
    return 1;
}
...
static int gbxlua_country_compass_social(lua_State *L) {
    lua_Integer a1 = luaL_checkinteger(L, 1);
    lua_pushnumber(L, (lua_Number)gearbox_country_compass_social((uint32_t)(a1)));
    return 1;
}
...
static int gbxlua_province_unrest(lua_State *L) {
    lua_Integer a1 = luaL_checkinteger(L, 1);
    lua_pushnumber(L, (lua_Number)gearbox_province_unrest((uint32_t)(a1)));
    return 1;
}
...
static int gbxlua_policy_count(lua_State *L) {
    (void)L;
    lua_pushinteger(L, (lua_Integer)gearbox_policy_count());
    return 1;
}
...
static int gbxlua_policy_id(lua_State *L) {
    lua_Integer a1 = luaL_checkinteger(L, 1);
    uint32_t need = gearbox_policy_id((uint32_t)(a1 - 1), NULL, 0);
    if (need == 0) { lua_pushliteral(L, ""); return 1; }
    luaL_Buffer b;
    char *dst = luaL_buffinitsize(L, &b, need);
    uint32_t got = gearbox_policy_id((uint32_t)(a1 - 1), dst, need);
    if (got > need) got = need;   /* host grew it between calls */
    luaL_pushresultsize(&b, got);
    return 1;
}
...
static int gbxlua_policy_name(lua_State *L) {
    lua_Integer a1 = luaL_checkinteger(L, 1);
    uint32_t need = gearbox_policy_name((uint32_t)(a1 - 1), NULL, 0);
    if (need == 0) { lua_pushliteral(L, ""); return 1; }
    luaL_Buffer b;
    char *dst = luaL_buffinitsize(L, &b, need);
    uint32_t got = gearbox_policy_name((uint32_t)(a1 - 1), dst, need);
    if (got > need) got = need;   /* host grew it between calls */
    luaL_pushresultsize(&b, got);
    return 1;
}
...
static int gbxlua_country_has_policy(lua_State *L) {
    ...
    size_t a2_n = 0;
    const char *a2 = luaL_checklstring(L, 2, &a2_n);
    lua_pushboolean(L, (int)gearbox_country_has_policy((uint32_t)(a1), a2, (uint32_t)a2_n));
    return 1;
}
...
static int gbxlua_province_minority_count(lua_State *L) {
    lua_Integer a1 = luaL_checkinteger(L, 1);
    lua_pushinteger(L, (lua_Integer)gearbox_province_minority_count((uint32_t)(a1)));
    return 1;
}
...
static int gbxlua_province_minority_name(lua_State *L) {
    lua_Integer a1 = luaL_checkinteger(L, 1);
    lua_Integer a2 = luaL_checkinteger(L, 2);
    uint32_t need = gearbox_province_minority_name((uint32_t)(a1), (uint32_t)(a2 - 1), NULL, 0);
    if (need == 0) { lua_pushliteral(L, ""); return 1; }
    luaL_Buffer b;
    char *dst = luaL_buffinitsize(L, &b, need);
    uint32_t got = gearbox_province_minority_name((uint32_t)(a1), (uint32_t)(a2 - 1), dst, need);
    if (got > need) got = need;   /* host grew it between calls */
    luaL_pushresultsize(&b, got);
    return 1;
}
...
static int gbxlua_province_minority_share(lua_State *L) {
    lua_Integer a1 = luaL_checkinteger(L, 1);
    lua_Integer a2 = luaL_checkinteger(L, 2);
    lua_pushnumber(L, (lua_Number)gearbox_province_minority_share((uint32_t)(a1), (uint32_t)(a2 - 1)));
    return 1;
}
...
static int gbxlua_country_district_count(lua_State *L) {
    lua_Integer a1 = luaL_checkinteger(L, 1);
    lua_pushinteger(L, (lua_Integer)gearbox_country_district_count((uint32_t)(a1)));
    return 1;
}
...
static int gbxlua_country_district_name(lua_State *L) {
    lua_Integer a1 = luaL_checkinteger(L, 1);
    lua_Integer a2 = luaL_checkinteger(L, 2);
    uint32_t need = gearbox_country_district_name((uint32_t)(a1), (uint32_t)(a2 - 1), NULL, 0);
    if (need == 0) { lua_pushliteral(L, ""); return 1; }
    luaL_Buffer b;
    char *dst = luaL_buffinitsize(L, &b, need);
    uint32_t got = gearbox_country_district_name((uint32_t)(a1), (uint32_t)(a2 - 1), dst, need);
    if (got > need) got = need;   /* host grew it between calls */
    luaL_pushresultsize(&b, got);
    return 1;
}
...
static int gbxlua_country_district_share(lua_State *L) {
    lua_Integer a1 = luaL_checkinteger(L, 1);
    lua_Integer a2 = luaL_checkinteger(L, 2);
    lua_pushinteger(L, (lua_Integer)gearbox_country_district_share((uint32_t)(a1), (uint32_t)(a2 - 1)));
    return 1;
}
...
static int gbxlua_country_district_province_count(lua_State *L) {
    lua_Integer a1 = luaL_checkinteger(L, 1);
    lua_Integer a2 = luaL_checkinteger(L, 2);
    lua_pushinteger(L, (lua_Integer)gearbox_country_district_province_count((uint32_t)(a1), (uint32_t)(a2 - 1)));
    return 1;
}
...
static int gbxlua_country_district_province(lua_State *L) {
    ...
    lua_Integer a2 = luaL_checkinteger(L, 2);
    lua_Integer a3 = luaL_checkinteger(L, 3);
    lua_pushinteger(L, (lua_Integer)gearbox_country_district_province((uint32_t)(a1), (uint32_t)(a2 - 1), (uint32_t)(a3)));
    return 1;
}
...
static int gbxlua_country_district_law_count(lua_State *L) {
    lua_Integer a1 = luaL_checkinteger(L, 1);
    lua_Integer a2 = luaL_checkinteger(L, 2);
    lua_pushinteger(L, (lua_Integer)gearbox_country_district_law_count((uint32_t)(a1), (uint32_t)(a2 - 1)));
    return 1;
}
...
static int gbxlua_country_district_law(lua_State *L) {
    ...
    lua_Integer a2 = luaL_checkinteger(L, 2);
    lua_Integer a3 = luaL_checkinteger(L, 3);
    uint32_t need = gearbox_country_district_law((uint32_t)(a1), (uint32_t)(a2 - 1), (uint32_t)(a3), NULL, 0);
    if (need == 0) { lua_pushliteral(L, ""); return 1; }
    luaL_Buffer b;
    char *dst = luaL_buffinitsize(L, &b, need);
    uint32_t got = gearbox_country_district_law((uint32_t)(a1), (uint32_t)(a2 - 1), (uint32_t)(a3), dst, need);
    if (got > need) got = need;   /* host grew it between calls */
    luaL_pushresultsize(&b, got);
    return 1;
}
...
static int gbxlua_district_law_count(lua_State *L) {
    (void)L;
    lua_pushinteger(L, (lua_Integer)gearbox_district_law_count());
    return 1;
}
...
static int gbxlua_district_law_id(lua_State *L) {
    lua_Integer a1 = luaL_checkinteger(L, 1);
    uint32_t need = gearbox_district_law_id((uint32_t)(a1 - 1), NULL, 0);
    if (need == 0) { lua_pushliteral(L, ""); return 1; }
    luaL_Buffer b;
    char *dst = luaL_buffinitsize(L, &b, need);
    uint32_t got = gearbox_district_law_id((uint32_t)(a1 - 1), dst, need);
    if (got > need) got = need;   /* host grew it between calls */
    luaL_pushresultsize(&b, got);
    return 1;
}
...
static int gbxlua_district_law_name(lua_State *L) {
    lua_Integer a1 = luaL_checkinteger(L, 1);
    uint32_t need = gearbox_district_law_name((uint32_t)(a1 - 1), NULL, 0);
    if (need == 0) { lua_pushliteral(L, ""); return 1; }
    luaL_Buffer b;
    char *dst = luaL_buffinitsize(L, &b, need);
    uint32_t got = gearbox_district_law_name((uint32_t)(a1 - 1), dst, need);
    if (got > need) got = need;   /* host grew it between calls */
    luaL_pushresultsize(&b, got);
    return 1;
}
...
static int gbxlua_country_discloses(lua_State *L) {
    lua_Integer a1 = luaL_checkinteger(L, 1);
    lua_Integer a2 = luaL_checkinteger(L, 2);
    lua_pushinteger(L, (lua_Integer)gearbox_country_discloses((uint32_t)(a1), (uint32_t)(a2)));
    return 1;
}
...
static int gbxlua_country_party_count(lua_State *L) {
    lua_Integer a1 = luaL_checkinteger(L, 1);
    lua_pushinteger(L, (lua_Integer)gearbox_country_party_count((uint32_t)(a1)));
    return 1;
}
...
static int gbxlua_country_party_name(lua_State *L) {
    lua_Integer a1 = luaL_checkinteger(L, 1);
    lua_Integer a2 = luaL_checkinteger(L, 2);
    uint32_t need = gearbox_country_party_name((uint32_t)(a1), (uint32_t)(a2 - 1), NULL, 0);
    if (need == 0) { lua_pushliteral(L, ""); return 1; }
    luaL_Buffer b;
    char *dst = luaL_buffinitsize(L, &b, need);
    uint32_t got = gearbox_country_party_name((uint32_t)(a1), (uint32_t)(a2 - 1), dst, need);
    if (got > need) got = need;   /* host grew it between calls */
    luaL_pushresultsize(&b, got);
    return 1;
}
...
static int gbxlua_country_party_short_name(lua_State *L) {
    lua_Integer a1 = luaL_checkinteger(L, 1);
    lua_Integer a2 = luaL_checkinteger(L, 2);
    uint32_t need = gearbox_country_party_short_name((uint32_t)(a1), (uint32_t)(a2 - 1), NULL, 0);
    if (need == 0) { lua_pushliteral(L, ""); return 1; }
    luaL_Buffer b;
    char *dst = luaL_buffinitsize(L, &b, need);
    uint32_t got = gearbox_country_party_short_name((uint32_t)(a1), (uint32_t)(a2 - 1), dst, need);
    if (got > need) got = need;   /* host grew it between calls */
    luaL_pushresultsize(&b, got);
    return 1;
}
...
static int gbxlua_country_party_support(lua_State *L) {
    lua_Integer a1 = luaL_checkinteger(L, 1);
    lua_Integer a2 = luaL_checkinteger(L, 2);
    lua_pushnumber(L, (lua_Number)gearbox_country_party_support((uint32_t)(a1), (uint32_t)(a2 - 1)));
    return 1;
}
...
static int gbxlua_country_party_compass_econ(lua_State *L) {
    lua_Integer a1 = luaL_checkinteger(L, 1);
    lua_Integer a2 = luaL_checkinteger(L, 2);
    lua_pushnumber(L, (lua_Number)gearbox_country_party_compass_econ((uint32_t)(a1), (uint32_t)(a2 - 1)));
    return 1;
}
...
static int gbxlua_country_party_compass_social(lua_State *L) {
    lua_Integer a1 = luaL_checkinteger(L, 1);
    lua_Integer a2 = luaL_checkinteger(L, 2);
    lua_pushnumber(L, (lua_Number)gearbox_country_party_compass_social((uint32_t)(a1), (uint32_t)(a2 - 1)));
    return 1;
}
...
static int gbxlua_country_party_is_historical(lua_State *L) {
    lua_Integer a1 = luaL_checkinteger(L, 1);
    lua_Integer a2 = luaL_checkinteger(L, 2);
    lua_pushinteger(L, (lua_Integer)gearbox_country_party_is_historical((uint32_t)(a1), (uint32_t)(a2 - 1)));
    return 1;
}
...
static int gbxlua_country_ruling_party(lua_State *L) {
    lua_Integer a1 = luaL_checkinteger(L, 1);
    lua_pushinteger(L, (lua_Integer)gearbox_country_ruling_party((uint32_t)(a1)));
    return 1;
}
...
static int gbxlua_set_country_policy(lua_State *L) {
    ...
    const char *a2 = luaL_checklstring(L, 2, &a2_n);
    lua_Integer a3 = luaL_checkinteger(L, 3);
    lua_pushboolean(L, (int)gearbox_set_country_policy((uint32_t)(a1), a2, (uint32_t)a2_n, (uint32_t)(a3)));
    return 1;
}
...
static int gbxlua_set_country_district_share(lua_State *L) {
    ...
    lua_Integer a2 = luaL_checkinteger(L, 2);
    lua_Integer a3 = luaL_checkinteger(L, 3);
    lua_pushinteger(L, (lua_Integer)gearbox_set_country_district_share((uint32_t)(a1), (uint32_t)(a2 - 1), (uint32_t)(a3)));
    return 1;
}
...
static int gbxlua_set_country_district_law(lua_State *L) {
    ...
    lua_pushinteger(L, (lua_Integer)gearbox_set_country_district_law((uint32_t)(a1), (uint32_t)(a2 - 1), a3, (uint32_t)a3_n, (uint32_t)(a4)));
    return 1;
}
...
static int gbxlua_set_country_disclosure(lua_State *L) {
    ...
    lua_Integer a2 = luaL_checkinteger(L, 2);
    lua_Integer a3 = luaL_checkinteger(L, 3);
    lua_pushinteger(L, (lua_Integer)gearbox_set_country_disclosure((uint32_t)(a1), (uint32_t)(a2), (uint32_t)(a3)));
    return 1;
}
...
static int gbxlua_node_count(lua_State *L) {
    (void)L;
    lua_pushinteger(L, (lua_Integer)gearbox_node_count());
    return 1;
}
...
static int gbxlua_node_id(lua_State *L) {
    lua_Integer a1 = luaL_checkinteger(L, 1);
    uint32_t need = gearbox_node_id((uint32_t)(a1 - 1), NULL, 0);
    if (need == 0) { lua_pushliteral(L, ""); return 1; }
    luaL_Buffer b;
    char *dst = luaL_buffinitsize(L, &b, need);
    uint32_t got = gearbox_node_id((uint32_t)(a1 - 1), dst, need);
    if (got > need) got = need;   /* host grew it between calls */
    luaL_pushresultsize(&b, got);
    return 1;
}
...
static int gbxlua_node_name(lua_State *L) {
    lua_Integer a1 = luaL_checkinteger(L, 1);
    uint32_t need = gearbox_node_name((uint32_t)(a1 - 1), NULL, 0);
    if (need == 0) { lua_pushliteral(L, ""); return 1; }
    luaL_Buffer b;
    char *dst = luaL_buffinitsize(L, &b, need);
    uint32_t got = gearbox_node_name((uint32_t)(a1 - 1), dst, need);
    if (got > need) got = need;   /* host grew it between calls */
    luaL_pushresultsize(&b, got);
    return 1;
}
...
static int gbxlua_node_category(lua_State *L) {
    lua_Integer a1 = luaL_checkinteger(L, 1);
    uint32_t need = gearbox_node_category((uint32_t)(a1 - 1), NULL, 0);
    if (need == 0) { lua_pushliteral(L, ""); return 1; }
    luaL_Buffer b;
    char *dst = luaL_buffinitsize(L, &b, need);
    uint32_t got = gearbox_node_category((uint32_t)(a1 - 1), dst, need);
    if (got > need) got = need;   /* host grew it between calls */
    luaL_pushresultsize(&b, got);
    return 1;
}
...
static int gbxlua_node_cost(lua_State *L) {
    lua_Integer a1 = luaL_checkinteger(L, 1);
    lua_pushinteger(L, (lua_Integer)gearbox_node_cost((uint32_t)(a1 - 1)));
    return 1;
}
...
static int gbxlua_country_has_researched(lua_State *L) {
    ...
    size_t a2_n = 0;
    const char *a2 = luaL_checklstring(L, 2, &a2_n);
    lua_pushboolean(L, (int)gearbox_country_has_researched((uint32_t)(a1), a2, (uint32_t)a2_n));
    return 1;
}
...
static int gbxlua_country_funding(lua_State *L) {
    lua_Integer a1 = luaL_checkinteger(L, 1);
    lua_pushnumber(L, (lua_Number)gearbox_country_funding((uint32_t)(a1)));
    return 1;
}
...
static int gbxlua_country_research_groups(lua_State *L) {
    lua_Integer a1 = luaL_checkinteger(L, 1);
    lua_pushinteger(L, (lua_Integer)gearbox_country_research_groups((uint32_t)(a1)));
    return 1;
}
...
static int gbxlua_set_country_funding(lua_State *L) {
    lua_Integer a1 = luaL_checkinteger(L, 1);
    double a2 = (double)luaL_checknumber(L, 2);
    lua_pushboolean(L, (int)gearbox_set_country_funding((uint32_t)(a1), a2));
    return 1;
}
...
static int gbxlua_set_country_research_groups(lua_State *L) {
    lua_Integer a1 = luaL_checkinteger(L, 1);
    lua_Integer a2 = luaL_checkinteger(L, 2);
    lua_pushinteger(L, (lua_Integer)gearbox_set_country_research_groups((uint32_t)(a1), (uint32_t)(a2)));
    return 1;
}
...
static int gbxlua_get(lua_State *L) {
    size_t a1_n = 0;
    const char *a1 = luaL_checklstring(L, 1, &a1_n);
    uint32_t need = gearbox_get(a1, (uint32_t)a1_n, NULL, 0);
    if (need == 0) { lua_pushliteral(L, ""); return 1; }
    luaL_Buffer b;
    char *dst = luaL_buffinitsize(L, &b, need);
    uint32_t got = gearbox_get(a1, (uint32_t)a1_n, dst, need);
    if (got > need) got = need;   /* host grew it between calls */
    luaL_pushresultsize(&b, got);
    return 1;
}
...
static int gbxlua_set(lua_State *L) {
    ...
    size_t a2_n = 0;
    const char *a2 = luaL_checklstring(L, 2, &a2_n);
    lua_pushboolean(L, (int)gearbox_set(a1, (uint32_t)a1_n, a2, (uint32_t)a2_n));
    return 1;
}
...
static int gbxlua_remove(lua_State *L) {
    size_t a1_n = 0;
    const char *a1 = luaL_checklstring(L, 1, &a1_n);
    lua_pushboolean(L, (int)gearbox_remove(a1, (uint32_t)a1_n));
    return 1;
}
...
static int gbxlua_panel_register(lua_State *L) {
    ...
    lua_Integer a2 = luaL_checkinteger(L, 2);
    lua_Integer a3 = luaL_checkinteger(L, 3);
    uint32_t h = gearbox_panel_register(a1, (uint32_t)a1_n, (uint32_t)(a2), (uint32_t)(a3));
    if (h == GEARBOX_INVALID) lua_pushnil(L);
    else lua_pushinteger(L, (lua_Integer)h);
    return 1;
}
...
static int gbxlua_draw_rect(lua_State *L) {
    ...
    gearbox_draw_rect((uint32_t)(a1), (int32_t)(a2), (int32_t)(a3), (int32_t)(a4), (int32_t)(a5), (uint32_t)(a6));
    return 0;
}
...
static int gbxlua_draw_text(lua_State *L) {
    ...
    lua_Integer a4 = luaL_checkinteger(L, 4);
    size_t a5_n = 0;
    const char *a5 = luaL_checklstring(L, 5, &a5_n);
    gearbox_draw_text((uint32_t)(a1), (int32_t)(a2), (int32_t)(a3), (uint32_t)(a4), a5, (uint32_t)a5_n);
    return 0;
}
...
static int gbxlua_button(lua_State *L) {
    ...
    lua_Integer a5 = luaL_checkinteger(L, 5);
    size_t a6_n = 0;
    const char *a6 = luaL_checklstring(L, 6, &a6_n);
    lua_pushboolean(L, (int)gearbox_button((uint32_t)(a1), (int32_t)(a2), (int32_t)(a3), (int32_t)(a4), (int32_t)(a5), a6, (uint32_t)a6_n));
    return 1;
}
...
static int gbxlua_draw_line(lua_State *L) {
    ...
    lua_Integer a4 = luaL_checkinteger(L, 4);
    lua_Integer a5 = luaL_checkinteger(L, 5);
    double a6 = (double)luaL_checknumber(L, 6);
    lua_Integer a7 = luaL_checkinteger(L, 7);
    gearbox_draw_line((uint32_t)(a1), (uint32_t)(a2), (uint32_t)(a3), (uint32_t)(a4), (uint32_t)(a5), a6, (uint32_t)(a7));
    return 0;
}
...
static int gbxlua_draw_circle(lua_State *L) {
    ...
    double a4 = (double)luaL_checknumber(L, 4);
    lua_Integer a5 = luaL_checkinteger(L, 5);
    gearbox_draw_circle((uint32_t)(a1), (uint32_t)(a2), (uint32_t)(a3), a4, (uint32_t)(a5));
    return 0;
}
...
static int gbxlua_draw_image(lua_State *L) {
    ...
    const char *a6 = luaL_checklstring(L, 6, &a6_n);
    lua_Integer a7 = luaL_checkinteger(L, 7);
    gearbox_draw_image((uint32_t)(a1), (uint32_t)(a2), (uint32_t)(a3), (uint32_t)(a4), (uint32_t)(a5), a6, (uint32_t)a6_n, (uint32_t)(a7));
    return 0;
}
...
static int gbxlua_draw_text_sized(lua_State *L) {
    ...
    size_t a6_n = 0;
    const char *a6 = luaL_checklstring(L, 6, &a6_n);
    gearbox_draw_text_sized((uint32_t)(a1), (uint32_t)(a2), (uint32_t)(a3), (uint32_t)(a4), (uint32_t)(a5), a6, (uint32_t)a6_n);
    return 0;
}
...
static int gbxlua_measure_text(lua_State *L) {
    ...
    const char *a1 = luaL_checklstring(L, 1, &a1_n);
    lua_Integer a2 = luaL_checkinteger(L, 2);
    lua_pushinteger(L, (lua_Integer)gearbox_measure_text(a1, (uint32_t)a1_n, (uint32_t)(a2)));
    return 1;
}
...
static int gbxlua_panel_width(lua_State *L) {
    lua_Integer a1 = luaL_checkinteger(L, 1);
    lua_pushinteger(L, (lua_Integer)gearbox_panel_width((uint32_t)(a1)));
    return 1;
}
...
static int gbxlua_panel_height(lua_State *L) {
    lua_Integer a1 = luaL_checkinteger(L, 1);
    lua_pushinteger(L, (lua_Integer)gearbox_panel_height((uint32_t)(a1)));
    return 1;
}
...
static int gbxlua_panel_set_visible(lua_State *L) {
    lua_Integer a1 = luaL_checkinteger(L, 1);
    lua_Integer a2 = luaL_checkinteger(L, 2);
    gearbox_panel_set_visible((uint32_t)(a1), (uint32_t)(a2));
    return 0;
}
...
static int gbxlua_mouse_x(lua_State *L) {
    lua_Integer a1 = luaL_checkinteger(L, 1);
    lua_pushnumber(L, (lua_Number)gearbox_mouse_x((uint32_t)(a1)));
    return 1;
}
...
static int gbxlua_mouse_y(lua_State *L) {
    lua_Integer a1 = luaL_checkinteger(L, 1);
    lua_pushnumber(L, (lua_Number)gearbox_mouse_y((uint32_t)(a1)));
    return 1;
}
...
static int gbxlua_mouse_inside(lua_State *L) {
    lua_Integer a1 = luaL_checkinteger(L, 1);
    lua_pushboolean(L, (int)gearbox_mouse_inside((uint32_t)(a1)));
    return 1;
}
...
static int gbxlua_theme_accent(lua_State *L) {
    (void)L;
    lua_pushinteger(L, (lua_Integer)gearbox_theme_accent());
    return 1;
}
...
static int gbxlua_set_theme_accent(lua_State *L) {
    lua_Integer a1 = luaL_checkinteger(L, 1);
    lua_pushboolean(L, (int)gearbox_set_theme_accent((uint32_t)(a1)));
    return 1;
}
#endif /* GBX_WITH_UI */

#endif /* GBX_LUA_GENERATED_H */
