...
def game_version() -> str:
    """The one the rest of the build stamps.

    CMakeLists reads this same file into OD_VERSION_STRING, so the TempleOS
    menu shows what the desktop game shows rather than a number somebody
    remembered to update twice.
    """
...
def render(views, consts) -> str:
    ...
    lines.append(f'#define SY_VERSION           "{game_version()}"')
    lines.append("")
