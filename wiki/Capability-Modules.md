...
| `UI` | Register panels and draw inside them | `panel_register`, `draw_rect`, `draw_text`, `button` | yes | implemented |
...
| `Neural` | Observe AI features and rewards (observe-only: no import writes to the model) | `feature_count`, `features`, `reward_count`, `reward_mean` | yes | implemented |
