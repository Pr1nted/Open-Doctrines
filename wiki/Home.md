...
250 host functions and exports up to 7 of its own. That is
...
Working: **Core, GameState.Read, UI, Assets, GameProcess, GameState.Write, Neural, Neural.Decide, Map, Diplomacy, Storage, Audio, Net, WasiStub, Military.Read, Military.Write, Research.Read, Research.Write, Politics.Read, Politics.Write, Economy.Read, Economy.Write, MapEditor, Core.Protected, Country, Scripts**.
